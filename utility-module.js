{% if request.design_mode %}
  ...
  <div id="utility-dialog" style="display:none;">
    ...
    <div class="dialog-content">
      ...
      <p id="theme-name"></p>
      <p>Caso não tenha uma Chave de Ativação, marque a caixa abaixo e Clique no Botão "Adquirir Licença".</p>
  ...
  <script data-module-main>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateThemeUpdateText() {
        ...
        themeUpdateText.textContent = `Tema Atualizado em ${currentMonth} de ${currentYear}`;
      }
